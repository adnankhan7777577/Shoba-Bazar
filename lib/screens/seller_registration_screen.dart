...
class _SellerRegistrationScreenState extends State<SellerRegistrationScreen> {
  ...
  Future<void> _pickImage() async {
    try {
      ...
      if (image != null) {
        ...
        context.read<SellerRegistrationCubit>().setImagePath(image.path);
      }
    } catch (e) {
  ...
  void _register() {
    ...
    context.read<SellerRegistrationCubit>().registerSeller(
      ...
      body: SafeArea(
        child: BlocConsumer<SellerRegistrationCubit, SellerRegistrationState>(
          ...
          builder: (context, state) {
            final isLoading = state is SellerRegistrationLoading;
